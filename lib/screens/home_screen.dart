...
class _HomeScreenState extends State<HomeScreen> {
  _buildRestaurants() {
    ...
    for (var restaurant in restaurants) {
      restaurantsList.add(
        GestureDetector(
          onTap: () {
            // Supprimer la logique liée aux publicités interstitielles
            Navigator.push(
              context,
              MaterialPageRoute(
  ...
  void initState() {
    super.initState();
    // Supprimer l'initialisation des annonces
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListView(physics: const BouncingScrollPhysics(), children: [
        ...
        // Supprimer les widgets d'annonce et les variables associées
        const RecentOrders(),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
